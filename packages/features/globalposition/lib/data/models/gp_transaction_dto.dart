...
part 'generated/gp_transaction_dto.g.dart';

@JsonSerializable()
class GpTransactionDto {
  const GpTransactionDto({
    required this.id,
  ...
  factory GpTransactionDto.fromJson(Map<String, dynamic> json) =>
      _$GpTransactionDtoFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$GpTransactionDtoToJson(this);
